...
import { sbListFolders, sbCreateFolder, sbUpdateFolder, sbDeleteFolder,
         ...
         sbUploadFile, sbDeleteFile, sbGetSignedUrl, showToast } from './api.js?v=20260515f';
import { esc, str, uid, svgIcon } from './utils.js?v=20260515f';
import { isAdmin, isClient, isEmployee, currentUser } from './auth.js?v=20260515f';
...
async function refreshDocsSection(clientId) {
  ...
  if (!container) return;
  const { state } = await import('./app.js?v=20260515f');
