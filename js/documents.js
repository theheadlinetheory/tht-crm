...
import { sbListFolders, sbCreateFolder, sbUpdateFolder, sbDeleteFolder,
         ...
         sbUploadFile, sbDeleteFile, sbGetSignedUrl, showToast } from './api.js?v=20260904120704';
import { esc, str, uid, svgIcon } from './utils.js?v=20260904120704';
import { isAdmin, isEmployee, currentUser } from './auth.js?v=20260904120704';
...
async function refreshDocsSection(clientId) {
  ...
  if (!container) return;
  const { state } = await import('./app.js?v=20260904120704');
