...
import { sbListFolders, sbCreateFolder, sbUpdateFolder, sbDeleteFolder,
         ...
         sbUploadFile, sbDeleteFile, sbGetSignedUrl, showToast } from './api.js?v=20260703f';
import { esc, str, uid, svgIcon } from './utils.js?v=20260703f';
import { isAdmin, isClient, isEmployee, currentUser } from './auth.js?v=20260703f';
...
async function refreshDocsSection(clientId) {
  ...
  if (!container) return;
  const { state } = await import('./app.js?v=20260703f');
