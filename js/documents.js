...
import { sbListFolders, sbCreateFolder, sbUpdateFolder, sbDeleteFolder,
         ...
         sbUploadFile, sbDeleteFile, sbGetSignedUrl, showToast } from './api.js?v=20260922004126';
import { esc, str, uid, svgIcon } from './utils.js?v=20260922004126';
import { isAdmin, isEmployee, currentUser } from './auth.js?v=20260922004126';
...
async function refreshDocsSection(clientId) {
  ...
  if (!container) return;
  const { state } = await import('./app.js?v=20260922004126');
