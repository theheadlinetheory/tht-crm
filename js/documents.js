...
import { sbListFolders, sbCreateFolder, sbUpdateFolder, sbDeleteFolder,
         ...
         sbUploadFile, sbDeleteFile, sbGetSignedUrl, showToast } from './api.js?v=20260925131125';
import { esc, str, uid, svgIcon } from './utils.js?v=20260925131125';
import { isAdmin, isEmployee, currentUser } from './auth.js?v=20260925131125';
...
async function refreshDocsSection(clientId) {
  ...
  if (!container) return;
  const { state } = await import('./app.js?v=20260925131125');
