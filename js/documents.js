...
import { sbListFolders, sbCreateFolder, sbUpdateFolder, sbDeleteFolder,
         ...
         sbUploadFile, sbDeleteFile, sbGetSignedUrl, showToast } from './api.js?v=20260731041244';
import { esc, str, uid, svgIcon } from './utils.js?v=20260731041244';
import { isAdmin, isEmployee, currentUser } from './auth.js?v=20260731041244';
...
async function refreshDocsSection(clientId) {
  ...
  if (!container) return;
  const { state } = await import('./app.js?v=20260731041244');
