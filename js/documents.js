...
import { sbListFolders, sbCreateFolder, sbUpdateFolder, sbDeleteFolder,
         ...
         sbUploadFile, sbDeleteFile, sbGetSignedUrl, showToast } from './api.js?v=20260918090653';
import { esc, str, uid, svgIcon } from './utils.js?v=20260918090653';
import { isAdmin, isEmployee, currentUser } from './auth.js?v=20260918090653';
...
async function refreshDocsSection(clientId) {
  ...
  if (!container) return;
  const { state } = await import('./app.js?v=20260918090653');
