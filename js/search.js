...
import { ACQUISITION_STAGES, NURTURE_STAGES, CLIENT_PALETTE, ALL_PIPELINES } from './config.js?v=20260723b';
import { render } from './render.js?v=20260723b';
import { getToday } from './utils.js?v=20260723b';
import { isEmployee, getOwnerNameForDeal } from './auth.js?v=20260723b';
