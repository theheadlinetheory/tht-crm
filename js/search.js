...
// ═══════════════════════════════════════════════════════════
import { state, clientPortalStages } from './app.js?v=20260508c';
import { ACQUISITION_STAGES, NURTURE_STAGES, CLIENT_PALETTE, ALL_PIPELINES } from './config.js?v=20260508c';
import { render } from './render.js?v=20260508c';
import { getToday } from './utils.js?v=20260508c';
import { isClient, isEmployee, currentUser, getOwnerNameForDeal } from './auth.js?v=20260508c';
import { lookupClientInfo } from './client-info.js?v=20260508c';
