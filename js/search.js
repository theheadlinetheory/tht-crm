...
// ═══════════════════════════════════════════════════════════
import { state, clientPortalStages } from './app.js?v=20260524a';
import { ACQUISITION_STAGES, NURTURE_STAGES, CLIENT_PALETTE, ALL_PIPELINES } from './config.js?v=20260524a';
import { render } from './render.js?v=20260524a';
import { getToday } from './utils.js?v=20260524a';
import { isClient, isEmployee, currentUser, getOwnerNameForDeal } from './auth.js?v=20260524a';
import { lookupClientInfo } from './client-info.js?v=20260524a';
