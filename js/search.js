...
// ═══════════════════════════════════════════════════════════
import { state, clientPortalStages } from './app.js?v=20260702d';
import { ACQUISITION_STAGES, NURTURE_STAGES, CLIENT_PALETTE, ALL_PIPELINES } from './config.js?v=20260702d';
import { render } from './render.js?v=20260702d';
import { getToday } from './utils.js?v=20260702d';
import { isClient, isEmployee, currentUser, getOwnerNameForDeal } from './auth.js?v=20260702d';
import { lookupClientInfo } from './client-info.js?v=20260702d';
