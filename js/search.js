...
import { ACQUISITION_STAGES, NURTURE_STAGES, CLIENT_PALETTE, ALL_PIPELINES } from './config.js?v=20260717f';
import { render } from './render.js?v=20260717f';
import { getToday } from './utils.js?v=20260717f';
import { isEmployee, getOwnerNameForDeal } from './auth.js?v=20260717f';
