...
import { sbCreateInteraction, showToast } from './api.js?v=20260905075112';
import { SUPABASE_URL, SUPABASE_ANON_KEY } from './config.js?v=20260905075112';
...
function openNurture(dealId, fromDemo) {
  ...
  import('./render.js?v=20260905075112').then(m => m.render());
}
