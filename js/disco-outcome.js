...
import { sbCreateInteraction, showToast } from './api.js?v=20260908133645';
import { SUPABASE_URL, SUPABASE_ANON_KEY } from './config.js?v=20260908133645';
...
function openNurture(dealId, fromDemo) {
  ...
  import('./render.js?v=20260908133645').then(m => m.render());
}
