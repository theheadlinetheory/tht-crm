...
import { sbCreateInteraction, showToast } from './api.js?v=20260907024838';
import { SUPABASE_URL, SUPABASE_ANON_KEY } from './config.js?v=20260907024838';
...
function openNurture(dealId, fromDemo) {
  ...
  import('./render.js?v=20260907024838').then(m => m.render());
}
