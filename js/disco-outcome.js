...
import { sbCreateInteraction, showToast } from './api.js?v=20260908142737';
import { SUPABASE_URL, SUPABASE_ANON_KEY } from './config.js?v=20260908142737';
...
function openNurture(dealId, fromDemo) {
  ...
  import('./render.js?v=20260908142737').then(m => m.render());
}
