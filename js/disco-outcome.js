...
import { sbCreateInteraction, showToast } from './api.js?v=20260910103239';
import { SUPABASE_URL, SUPABASE_ANON_KEY } from './config.js?v=20260910103239';
...
function openNurture(dealId, fromDemo) {
  ...
  import('./render.js?v=20260910103239').then(m => m.render());
}
