...
import { sbCreateInteraction, showToast } from './api.js?v=20260909080427';
import { SUPABASE_URL, SUPABASE_ANON_KEY } from './config.js?v=20260909080427';
...
function openNurture(dealId, fromDemo) {
  ...
  import('./render.js?v=20260909080427').then(m => m.render());
}
