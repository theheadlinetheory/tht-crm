...
import { sbCreateInteraction, showToast } from './api.js?v=20260909034836';
import { SUPABASE_URL, SUPABASE_ANON_KEY } from './config.js?v=20260909034836';
...
function openNurture(dealId, fromDemo) {
  ...
  import('./render.js?v=20260909034836').then(m => m.render());
}
