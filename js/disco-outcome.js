...
import { sbCreateInteraction, showToast } from './api.js?v=20260904185541';
import { SUPABASE_URL, SUPABASE_ANON_KEY } from './config.js?v=20260904185541';
...
function openNurture(dealId, fromDemo) {
  ...
  import('./render.js?v=20260904185541').then(m => m.render());
}
