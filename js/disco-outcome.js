...
import { sbCreateInteraction, showToast } from './api.js?v=20260910123452';
import { SUPABASE_URL, SUPABASE_ANON_KEY } from './config.js?v=20260910123452';
...
function openNurture(dealId, fromDemo) {
  ...
  import('./render.js?v=20260910123452').then(m => m.render());
}
