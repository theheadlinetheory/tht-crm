...
import { sbCreateInteraction, showToast } from './api.js?v=20260908145001';
import { SUPABASE_URL, SUPABASE_ANON_KEY } from './config.js?v=20260908145001';
...
function openNurture(dealId, fromDemo) {
  ...
  import('./render.js?v=20260908145001').then(m => m.render());
}
