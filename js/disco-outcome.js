...
import { sbCreateInteraction, showToast } from './api.js?v=20260908140903';
import { SUPABASE_URL, SUPABASE_ANON_KEY } from './config.js?v=20260908140903';
...
function openNurture(dealId, fromDemo) {
  ...
  import('./render.js?v=20260908140903').then(m => m.render());
}
