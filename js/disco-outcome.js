...
import { sbCreateInteraction, showToast } from './api.js?v=20260909122843';
import { SUPABASE_URL, SUPABASE_ANON_KEY } from './config.js?v=20260909122843';
...
function openNurture(dealId, fromDemo) {
  ...
  import('./render.js?v=20260909122843').then(m => m.render());
}
