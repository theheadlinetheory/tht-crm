...
import { str, esc, uid, getToday } from './utils.js?v=20260531i';
import { invokeEdgeFunction, sbCreateActivity, camelToSnake } from './api.js?v=20260531i';
import { getBestNumberForLead, getRegionForPhone, recordCallOutcome } from './number-health.js?v=20260531i';
import { JUSTCALL_USER_MAP } from './config.js?v=20260531i';
import { currentUser } from './auth.js?v=20260531i';
...
async function onCallEnded(){
  ...
  try {
    ...
    const { refreshModal } = await import('./render.js?v=20260531i');
