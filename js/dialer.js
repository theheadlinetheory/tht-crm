...
import { str, esc, uid, getToday } from './utils.js?v=20260512a';
import { invokeEdgeFunction, sbCreateActivity, camelToSnake } from './api.js?v=20260512a';
import { getBestNumberForLead, getRegionForPhone, recordCallOutcome } from './number-health.js?v=20260512a';
import { JUSTCALL_USER_MAP } from './config.js?v=20260512a';
import { currentUser } from './auth.js?v=20260512a';
...
async function onCallEnded(){
  ...
  try {
    ...
    const { refreshModal } = await import('./render.js?v=20260512a');
