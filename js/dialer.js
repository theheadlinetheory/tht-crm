...
// ═══════════════════════════════════════════════════════════
import { state } from './app.js?v=20260531h';
import { str, esc, uid, getToday } from './utils.js?v=20260531h';
import { invokeEdgeFunction, sbCreateActivity, camelToSnake } from './api.js?v=20260531h';
import { getBestNumberForLead, getRegionForPhone, recordCallOutcome } from './number-health.js?v=20260531h';
import { JUSTCALL_USER_MAP } from './config.js?v=20260531h';
import { currentUser } from './auth.js?v=20260531h';
...
async function onCallEnded(){
  ...
  try {
    ...
    const { refreshModal } = await import('./render.js?v=20260531h');
