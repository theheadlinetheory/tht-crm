...
// ═══════════════════════════════════════════════════════════
import { state } from './app.js?v=20260531g';
import { str, esc, uid, getToday } from './utils.js?v=20260531g';
import { invokeEdgeFunction, sbCreateActivity, camelToSnake } from './api.js?v=20260531g';
import { getBestNumberForLead, getRegionForPhone, recordCallOutcome } from './number-health.js?v=20260531g';
import { JUSTCALL_USER_MAP } from './config.js?v=20260531g';
import { currentUser } from './auth.js?v=20260531g';
...
async function onCallEnded(){
  ...
  try {
    ...
    const { refreshModal } = await import('./render.js?v=20260531g');
