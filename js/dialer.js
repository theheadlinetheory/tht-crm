...
import { str, esc, uid, getToday } from './utils.js?v=20260713a';
import { invokeEdgeFunction, sbCreateActivity, camelToSnake } from './api.js?v=20260713a';
import { getBestNumberForLead, getRegionForPhone, recordCallOutcome } from './number-health.js?v=20260713a';
...
async function onCallEnded(){
  ...
  try {
    ...
    const { refreshModal } = await import('./render.js?v=20260713a');
