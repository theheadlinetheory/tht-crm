...
// ═══════════════════════════════════════════════════════════
import { state } from './app.js?v=20260518b';
import { str, esc, uid, getToday } from './utils.js?v=20260518b';
import { invokeEdgeFunction, sbCreateActivity, camelToSnake } from './api.js?v=20260518b';
import { getBestNumberForLead, getRegionForPhone, recordCallOutcome } from './number-health.js?v=20260518b';
import { JUSTCALL_USER_MAP } from './config.js?v=20260518b';
import { currentUser } from './auth.js?v=20260518b';
...
async function onCallEnded(){
  ...
  try {
    ...
    const { refreshModal } = await import('./render.js?v=20260518b');
