...
import { str, esc, uid, getToday } from './utils.js?v=20260601b';
import { invokeEdgeFunction, sbCreateActivity, camelToSnake } from './api.js?v=20260601b';
import { getBestNumberForLead, getRegionForPhone, recordCallOutcome } from './number-health.js?v=20260601b';
import { JUSTCALL_USER_MAP } from './config.js?v=20260601b';
import { currentUser } from './auth.js?v=20260601b';
...
async function onCallEnded(){
  ...
  try {
    ...
    const { refreshModal } = await import('./render.js?v=20260601b');
