...
// ═══════════════════════════════════════════════════════════
import { state } from './app.js?v=20260515e';
import { str, esc, uid, getToday } from './utils.js?v=20260515e';
import { invokeEdgeFunction, sbCreateActivity, camelToSnake } from './api.js?v=20260515e';
import { getBestNumberForLead, getRegionForPhone, recordCallOutcome } from './number-health.js?v=20260515e';
import { JUSTCALL_USER_MAP } from './config.js?v=20260515e';
import { currentUser } from './auth.js?v=20260515e';
...
async function onCallEnded(){
  ...
  try {
    ...
    const { refreshModal } = await import('./render.js?v=20260515e');
