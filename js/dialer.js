...
import { str, esc, uid, getToday } from './utils.js?v=20260620c';
import { invokeEdgeFunction, sbCreateActivity, camelToSnake } from './api.js?v=20260620c';
import { getBestNumberForLead, getRegionForPhone, recordCallOutcome } from './number-health.js?v=20260620c';
...
async function onCallEnded(){
  ...
  try {
    ...
    const { refreshModal } = await import('./render.js?v=20260620c');
