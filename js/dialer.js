...
import { str, esc, uid, getToday } from './utils.js?v=20260717a';
import { invokeEdgeFunction, sbCreateActivity, camelToSnake } from './api.js?v=20260717a';
import { getBestNumberForLead, getRegionForPhone, recordCallOutcome } from './number-health.js?v=20260717a';
...
async function onCallEnded(){
  ...
  try {
    ...
    const { refreshModal } = await import('./render.js?v=20260717a');
