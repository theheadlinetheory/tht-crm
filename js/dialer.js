...
import { str, esc, uid, getToday } from './utils.js?v=20260531j';
import { invokeEdgeFunction, sbCreateActivity, camelToSnake } from './api.js?v=20260531j';
import { getBestNumberForLead, getRegionForPhone, recordCallOutcome } from './number-health.js?v=20260531j';
import { JUSTCALL_USER_MAP } from './config.js?v=20260531j';
import { currentUser } from './auth.js?v=20260531j';
...
async function onCallEnded(){
  ...
  try {
    ...
    const { refreshModal } = await import('./render.js?v=20260531j');
