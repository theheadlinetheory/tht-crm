...
// ═══════════════════════════════════════════════════════════
import { state } from './app.js?v=20260515d';
import { str, esc, uid, getToday } from './utils.js?v=20260515d';
import { invokeEdgeFunction, sbCreateActivity, camelToSnake } from './api.js?v=20260515d';
import { getBestNumberForLead, getRegionForPhone, recordCallOutcome } from './number-health.js?v=20260515d';
import { JUSTCALL_USER_MAP } from './config.js?v=20260515d';
import { currentUser } from './auth.js?v=20260515d';
...
async function onCallEnded(){
  ...
  try {
    ...
    const { refreshModal } = await import('./render.js?v=20260515d');
