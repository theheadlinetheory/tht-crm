...
import { str, esc, uid, getToday } from './utils.js?v=20260918092747';
import { invokeEdgeFunction, sbCreateActivity, camelToSnake } from './api.js?v=20260918092747';
import { getBestNumberForLead, getRegionForPhone, recordCallOutcome } from './number-health.js?v=20260918092747';
...
async function onCallEnded(){
  ...
  try {
    ...
    const { refreshModal } = await import('./render.js?v=20260918092747');
