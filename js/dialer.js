...
import { str, esc, uid, getToday } from './utils.js?v=20260908140903';
import { invokeEdgeFunction, sbCreateActivity, camelToSnake } from './api.js?v=20260908140903';
import { getBestNumberForLead, getRegionForPhone, recordCallOutcome } from './number-health.js?v=20260908140903';
...
async function onCallEnded(){
  ...
  try {
    ...
    const { refreshModal } = await import('./render.js?v=20260908140903');
