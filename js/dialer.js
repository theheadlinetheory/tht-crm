...
import { str, esc, uid, getToday } from './utils.js?v=20260908143625';
import { invokeEdgeFunction, sbCreateActivity, camelToSnake } from './api.js?v=20260908143625';
import { getBestNumberForLead, getRegionForPhone, recordCallOutcome } from './number-health.js?v=20260908143625';
...
async function onCallEnded(){
  ...
  try {
    ...
    const { refreshModal } = await import('./render.js?v=20260908143625');
