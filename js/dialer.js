...
// ═══════════════════════════════════════════════════════════
import { state } from './app.js?v=20260527a';
import { str, esc, uid, getToday } from './utils.js?v=20260527a';
import { invokeEdgeFunction, sbCreateActivity, camelToSnake } from './api.js?v=20260527a';
import { getBestNumberForLead, getRegionForPhone, recordCallOutcome } from './number-health.js?v=20260527a';
import { JUSTCALL_USER_MAP } from './config.js?v=20260527a';
import { currentUser } from './auth.js?v=20260527a';
...
async function onCallEnded(){
  ...
  try {
    ...
    const { refreshModal } = await import('./render.js?v=20260527a');
