...
import { str, esc, getToday } from './utils.js?v=20260716a';
import { createClientRecord, deriveTimezone } from './client-info.js?v=20260716a';
import { ensureLeadTrackerSheet } from './lead-tracker-sheet.js?v=20260716a';
import { invokeEdgeFunction, showToast } from './api.js?v=20260716a';
