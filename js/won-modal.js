...
import { str, esc, getToday } from './utils.js?v=20260714f';
import { createClientRecord, deriveTimezone } from './client-info.js?v=20260714f';
import { ensureLeadTrackerSheet } from './lead-tracker-sheet.js?v=20260714f';
import { invokeEdgeFunction, showToast } from './api.js?v=20260714f';
