...
// repo's role rule.
// ═══════════════════════════════════════════════════════════
import { esc, str } from './utils.js?v=20260918092747';
import { addMonths, prettyDate, prepaidThrough } from './retainer-billing.js?v=20260918092747';
import { cadenceOf, daysLeft, monthlyEquivalent, termEnd } from './client-terms.js?v=20260918092747';
import { extensionsFor, extensionsStatus, loadTermExtensions } from './term-extensions.js?v=20260918092747';
...
export function buildRenewalRow(c, todayIso, extensions = []) {
  ...
  else if (cadence === 'Weekly' || cadence === 'Biweekly') flags.push({ text: `paid ${cadence.toLowerCase()}: invoice by hand`, bad: false });
