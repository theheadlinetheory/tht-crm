...
// ═══════════════════════════════════════════════════════════
import { state, store, pendingWrites, deletedClientIds } from './app.js?v=20260531a';
import { CLIENT_PALETTE, CLIENT_INFO_SHEET_ID } from './config.js?v=20260531a';
import { render } from './render.js?v=20260531a';
import { str, uid, esc, isValidDate, getToday, svgIcon } from './utils.js?v=20260531a';
import { sbCreateClient, sbDeleteClient, camelToSnake, apiPost, invokeEdgeFunction, showToast } from './api.js?v=20260531a';
import { isClient, isAdmin } from './auth.js?v=20260531a';
...
export async function loadClientConfig() {
  try {
    const { sbGetClientConfig } = await import('./api.js?v=20260531a');
