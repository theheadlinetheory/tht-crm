...
// ═══════════════════════════════════════════════════════════
import { state, store, pendingWrites, deletedClientIds } from './app.js?v=20260531i';
import { CLIENT_PALETTE, CLIENT_INFO_SHEET_ID } from './config.js?v=20260531i';
import { render } from './render.js?v=20260531i';
import { str, uid, esc, isValidDate, getToday, svgIcon } from './utils.js?v=20260531i';
import { sbCreateClient, sbDeleteClient, camelToSnake, apiPost, invokeEdgeFunction, showToast } from './api.js?v=20260531i';
import { isClient, isAdmin } from './auth.js?v=20260531i';
...
export async function loadClientConfig() {
  try {
    const { sbGetClientConfig } = await import('./api.js?v=20260531i');
