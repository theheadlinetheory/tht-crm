...
// ═══════════════════════════════════════════════════════════
import { state, store, pendingWrites, deletedClientIds } from './app.js?v=20260703f';
import { CLIENT_PALETTE, CLIENT_INFO_SHEET_ID } from './config.js?v=20260703f';
import { render } from './render.js?v=20260703f';
import { str, uid, esc, isValidDate, getToday, svgIcon } from './utils.js?v=20260703f';
import { sbCreateClient, sbDeleteClient, camelToSnake, apiPost, invokeEdgeFunction, showToast, supabase } from './api.js?v=20260703f';
import { isClient, isAdmin } from './auth.js?v=20260703f';
...
export async function loadClientConfig() {
  try {
    const { sbGetClientConfig } = await import('./api.js?v=20260703f');
