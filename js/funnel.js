...
import { PERIODS, periodRange, fetchPeriod } from './funnel-period.js?v=20260909034836';
...
window.setFunnelPeriod = (key) => {
  ...
  import('./render.js?v=20260909034836').then(m => { if (key !== 'all') loadPeriod(key, m.render); m.render(); });
};
...
window.refreshFunnel = () => {
  import('./render.js?v=20260909034836').then(m => reloadFunnel(m.render));
};
