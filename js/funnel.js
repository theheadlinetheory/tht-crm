...
import { PERIODS, periodRange, fetchPeriod, rangeLabel } from './funnel-period.js?v=20260913212736';
import { leadsTable } from './funnel-leads.js?v=20260913212736';
...
window.setFunnelPeriod = (key) => {
  ...
  import('./render.js?v=20260913212736').then(m => { if (key !== 'all') loadPeriod(key, m.render); m.render(); });
};
...
window.refreshFunnel = () => {
  import('./render.js?v=20260913212736').then(m => reloadFunnel(m.render));
};
