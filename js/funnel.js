...
import { PERIODS, periodRange, fetchPeriod } from './funnel-period.js?v=20260908140903';
...
window.setFunnelPeriod = (key) => {
  ...
  import('./render.js?v=20260908140903').then(m => { if (key !== 'all') loadPeriod(key, m.render); m.render(); });
};
...
window.refreshFunnel = () => {
  import('./render.js?v=20260908140903').then(m => reloadFunnel(m.render));
};
