...
import { PERIODS, periodRange, fetchPeriod, rangeLabel } from './funnel-period.js?v=20260910153952';
import { leadsTable } from './funnel-leads.js?v=20260910153952';
...
window.setFunnelPeriod = (key) => {
  ...
  import('./render.js?v=20260910153952').then(m => { if (key !== 'all') loadPeriod(key, m.render); m.render(); });
};
...
window.refreshFunnel = () => {
  import('./render.js?v=20260910153952').then(m => reloadFunnel(m.render));
};
