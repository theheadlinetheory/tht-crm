...
import { PERIODS, periodRange, fetchPeriod } from './funnel-period.js?v=20260910103638';
import { leadsTable } from './funnel-leads.js?v=20260910103638';
...
window.setFunnelPeriod = (key) => {
  ...
  import('./render.js?v=20260910103638').then(m => { if (key !== 'all') loadPeriod(key, m.render); m.render(); });
};
...
window.refreshFunnel = () => {
  import('./render.js?v=20260910103638').then(m => reloadFunnel(m.render));
};
