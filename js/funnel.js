...
import { PERIODS, periodRange, fetchPeriod, rangeLabel } from './funnel-period.js?v=20260910163134';
import { leadsTable } from './funnel-leads.js?v=20260910163134';
...
window.setFunnelPeriod = (key) => {
  ...
  import('./render.js?v=20260910163134').then(m => { if (key !== 'all') loadPeriod(key, m.render); m.render(); });
};
...
window.refreshFunnel = () => {
  import('./render.js?v=20260910163134').then(m => reloadFunnel(m.render));
};
