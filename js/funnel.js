...
import { PERIODS, periodRange, fetchPeriod } from './funnel-period.js?v=20260908130712';
...
window.setFunnelPeriod = (key) => {
  _period = key;
  import('./render.js?v=20260908130712').then(m => { if (key !== 'all') loadPeriod(key, m.render); m.render(); });
};
...
window.refreshFunnel = () => {
  import('./render.js?v=20260908130712').then(m => reloadFunnel(m.render));
};
