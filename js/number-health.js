...
import { supabase } from './api.js?v=20260717d';
import { sbCall } from './api.js?v=20260717d';
import { esc, svgIcon } from './utils.js?v=20260717d';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260717d');
  render();
};
