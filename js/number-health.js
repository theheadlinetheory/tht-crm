...
import { supabase } from './api.js?v=20260728143500';
import { sbCall } from './api.js?v=20260728143500';
import { esc, svgIcon } from './utils.js?v=20260728143500';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260728143500');
  render();
};
