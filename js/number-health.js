...
import { supabase } from './api.js?v=20260803145856';
import { sbCall } from './api.js?v=20260803145856';
import { esc, svgIcon } from './utils.js?v=20260803145856';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260803145856');
  render();
};
