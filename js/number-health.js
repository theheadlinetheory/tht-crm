...
import { supabase } from './api.js?v=20260806010537';
import { sbCall } from './api.js?v=20260806010537';
import { esc, svgIcon } from './utils.js?v=20260806010537';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260806010537');
  render();
};
