...
import { supabase } from './api.js?v=20260904160806';
import { sbCall } from './api.js?v=20260904160806';
import { esc, svgIcon } from './utils.js?v=20260904160806';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260904160806');
  render();
};
