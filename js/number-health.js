...
import { supabase } from './api.js?v=20260730111823';
import { sbCall } from './api.js?v=20260730111823';
import { esc, svgIcon } from './utils.js?v=20260730111823';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260730111823');
  render();
};
