...
import { supabase } from './api.js?v=20260905104727';
import { sbCall } from './api.js?v=20260905104727';
import { esc, svgIcon } from './utils.js?v=20260905104727';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260905104727');
  render();
};
