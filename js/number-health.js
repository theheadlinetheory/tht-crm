...
import { supabase } from './api.js?v=20260916144750';
import { sbCall } from './api.js?v=20260916144750';
import { esc, svgIcon } from './utils.js?v=20260916144750';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260916144750');
  render();
};
