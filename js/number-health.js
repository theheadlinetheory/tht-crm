...
import { supabase } from './api.js?v=20260905075112';
import { sbCall } from './api.js?v=20260905075112';
import { esc, svgIcon } from './utils.js?v=20260905075112';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260905075112');
  render();
};
