...
import { supabase } from './api.js?v=20260905112009';
import { sbCall } from './api.js?v=20260905112009';
import { esc, svgIcon } from './utils.js?v=20260905112009';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260905112009');
  render();
};
