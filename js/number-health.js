...
import { supabase } from './api.js?v=20260818040001';
import { sbCall } from './api.js?v=20260818040001';
import { esc, svgIcon } from './utils.js?v=20260818040001';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260818040001');
  render();
};
