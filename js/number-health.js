...
import { supabase } from './api.js?v=20260916150226';
import { sbCall } from './api.js?v=20260916150226';
import { esc, svgIcon } from './utils.js?v=20260916150226';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260916150226');
  render();
};
