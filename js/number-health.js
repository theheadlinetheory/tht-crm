...
import { supabase } from './api.js?v=20260910163820';
import { sbCall } from './api.js?v=20260910163820';
import { esc, svgIcon } from './utils.js?v=20260910163820';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260910163820');
  render();
};
