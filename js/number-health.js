...
import { supabase } from './api.js?v=20260907024838';
import { sbCall } from './api.js?v=20260907024838';
import { esc, svgIcon } from './utils.js?v=20260907024838';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260907024838');
  render();
};
