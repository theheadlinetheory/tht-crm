...
import { supabase } from './api.js?v=20260803163104';
import { sbCall } from './api.js?v=20260803163104';
import { esc, svgIcon } from './utils.js?v=20260803163104';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260803163104');
  render();
};
