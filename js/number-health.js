...
import { supabase } from './api.js?v=20260717g';
import { sbCall } from './api.js?v=20260717g';
import { esc, svgIcon } from './utils.js?v=20260717g';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260717g');
  render();
};
