...
import { supabase } from './api.js?v=20260723b';
import { sbCall } from './api.js?v=20260723b';
import { esc, svgIcon } from './utils.js?v=20260723b';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260723b');
  render();
};
