...
import { supabase } from './api.js?v=20260723a';
import { sbCall } from './api.js?v=20260723a';
import { esc, svgIcon } from './utils.js?v=20260723a';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260723a');
  render();
};
