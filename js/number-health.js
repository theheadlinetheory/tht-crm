...
import { supabase } from './api.js?v=20260821052046';
import { sbCall } from './api.js?v=20260821052046';
import { esc, svgIcon } from './utils.js?v=20260821052046';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260821052046');
  render();
};
