...
import { supabase } from './api.js?v=20260730101500';
import { sbCall } from './api.js?v=20260730101500';
import { esc, svgIcon } from './utils.js?v=20260730101500';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260730101500');
  render();
};
