...
import { supabase } from './api.js?v=20260913215731';
import { sbCall } from './api.js?v=20260913215731';
import { esc, svgIcon } from './utils.js?v=20260913215731';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260913215731');
  render();
};
