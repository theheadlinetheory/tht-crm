...
import { supabase } from './api.js?v=20260815193007';
import { sbCall } from './api.js?v=20260815193007';
import { esc, svgIcon } from './utils.js?v=20260815193007';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260815193007');
  render();
};
