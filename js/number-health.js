...
import { supabase } from './api.js?v=20260903132824';
import { sbCall } from './api.js?v=20260903132824';
import { esc, svgIcon } from './utils.js?v=20260903132824';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260903132824');
  render();
};
