...
import { supabase } from './api.js?v=20260918092957';
import { sbCall } from './api.js?v=20260918092957';
import { esc, svgIcon } from './utils.js?v=20260918092957';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260918092957');
  render();
};
