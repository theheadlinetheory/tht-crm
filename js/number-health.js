...
import { supabase } from './api.js?v=20260730093000';
import { sbCall } from './api.js?v=20260730093000';
import { esc, svgIcon } from './utils.js?v=20260730093000';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260730093000');
  render();
};
