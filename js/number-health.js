...
import { supabase } from './api.js?v=20260827115154';
import { sbCall } from './api.js?v=20260827115154';
import { esc, svgIcon } from './utils.js?v=20260827115154';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260827115154');
  render();
};
