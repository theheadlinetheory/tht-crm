...
import { supabase } from './api.js?v=20260717141537';
import { sbCall } from './api.js?v=20260717141537';
import { esc, svgIcon } from './utils.js?v=20260717141537';
...
const AC_TO_STATE = {
  ...
  // Canadian area codes
  204:'MB',226:'ON',236:'BC',249:'ON',250:'BC',289:'ON',306:'SK',343:'ON',
  365:'ON',403:'AB',416:'ON',418:'QC',431:'MB',437:'ON',438:'QC',450:'QC',
  506:'NB',514:'QC',519:'ON',548:'ON',579:'QC',581:'QC',587:'AB',604:'BC',
  613:'ON',639:'SK',647:'ON',672:'BC',705:'ON',709:'NL',742:'ON',778:'BC',
  780:'AB',782:'NS',807:'ON',819:'QC',825:'AB',867:'NT',873:'QC',902:'NS',
  905:'ON'
};
...
const STATE_TO_TZ = {
  ...
  // Canadian provinces
  ON:'ET',QC:'ET',NB:'AT',NS:'AT',PE:'AT',NL:'NT',
  MB:'CT',SK:'CT',AB:'MT',BC:'PT',
};
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260717141537');
  render();
};
