...
import { supabase } from './api.js?v=20260814103753';
import { sbCall } from './api.js?v=20260814103753';
import { esc, svgIcon } from './utils.js?v=20260814103753';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260814103753');
  render();
};
