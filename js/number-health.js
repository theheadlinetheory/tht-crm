...
import { supabase } from './api.js?v=20260918091352';
import { sbCall } from './api.js?v=20260918091352';
import { esc, svgIcon } from './utils.js?v=20260918091352';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260918091352');
  render();
};
