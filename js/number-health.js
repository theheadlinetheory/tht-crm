...
import { supabase } from './api.js?v=20260826144756';
import { sbCall } from './api.js?v=20260826144756';
import { esc, svgIcon } from './utils.js?v=20260826144756';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260826144756');
  render();
};
