...
import { supabase } from './api.js?v=20260821053449';
import { sbCall } from './api.js?v=20260821053449';
import { esc, svgIcon } from './utils.js?v=20260821053449';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260821053449');
  render();
};
