...
import { supabase } from './api.js?v=20260801054521';
import { sbCall } from './api.js?v=20260801054521';
import { esc, svgIcon } from './utils.js?v=20260801054521';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260801054521');
  render();
};
