...
import { supabase } from './api.js?v=20260911110145';
import { sbCall } from './api.js?v=20260911110145';
import { esc, svgIcon } from './utils.js?v=20260911110145';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260911110145');
  render();
};
