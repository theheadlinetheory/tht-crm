...
import { supabase } from './api.js?v=20260827212923';
import { sbCall } from './api.js?v=20260827212923';
import { esc, svgIcon } from './utils.js?v=20260827212923';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260827212923');
  render();
};
