...
import { supabase } from './api.js?v=20260914121323';
import { sbCall } from './api.js?v=20260914121323';
import { esc, svgIcon } from './utils.js?v=20260914121323';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260914121323');
  render();
};
