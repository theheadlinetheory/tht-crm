...
import { supabase } from './api.js?v=20260717i';
import { sbCall } from './api.js?v=20260717i';
import { esc, svgIcon } from './utils.js?v=20260717i';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260717i');
  render();
};
