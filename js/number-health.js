...
import { supabase } from './api.js?v=20260807034647';
import { sbCall } from './api.js?v=20260807034647';
import { esc, svgIcon } from './utils.js?v=20260807034647';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260807034647');
  render();
};
