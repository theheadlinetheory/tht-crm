...
import { supabase } from './api.js?v=20260801034132';
import { sbCall } from './api.js?v=20260801034132';
import { esc, svgIcon } from './utils.js?v=20260801034132';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260801034132');
  render();
};
