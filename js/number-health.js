...
import { supabase } from './api.js?v=20260911105951';
import { sbCall } from './api.js?v=20260911105951';
import { esc, svgIcon } from './utils.js?v=20260911105951';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260911105951');
  render();
};
