...
import { supabase } from './api.js?v=20260820073712';
import { sbCall } from './api.js?v=20260820073712';
import { esc, svgIcon } from './utils.js?v=20260820073712';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260820073712');
  render();
};
