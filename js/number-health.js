...
import { supabase } from './api.js?v=20260905105303';
import { sbCall } from './api.js?v=20260905105303';
import { esc, svgIcon } from './utils.js?v=20260905105303';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260905105303');
  render();
};
