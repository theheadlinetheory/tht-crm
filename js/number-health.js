...
import { supabase } from './api.js?v=20260731041244';
import { sbCall } from './api.js?v=20260731041244';
import { esc, svgIcon } from './utils.js?v=20260731041244';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260731041244');
  render();
};
