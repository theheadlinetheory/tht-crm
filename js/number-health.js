...
import { supabase } from './api.js?v=20260827005843';
import { sbCall } from './api.js?v=20260827005843';
import { esc, svgIcon } from './utils.js?v=20260827005843';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260827005843');
  render();
};
