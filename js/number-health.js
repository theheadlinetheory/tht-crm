...
import { supabase } from './api.js?v=20260827062322';
import { sbCall } from './api.js?v=20260827062322';
import { esc, svgIcon } from './utils.js?v=20260827062322';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260827062322');
  render();
};
