...
import { supabase } from './api.js?v=20260815165540';
import { sbCall } from './api.js?v=20260815165540';
import { esc, svgIcon } from './utils.js?v=20260815165540';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260815165540');
  render();
};
