...
import { supabase } from './api.js?v=20260808025240';
import { sbCall } from './api.js?v=20260808025240';
import { esc, svgIcon } from './utils.js?v=20260808025240';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260808025240');
  render();
};
