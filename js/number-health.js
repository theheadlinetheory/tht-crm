...
import { supabase } from './api.js?v=20260911102002';
import { sbCall } from './api.js?v=20260911102002';
import { esc, svgIcon } from './utils.js?v=20260911102002';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260911102002');
  render();
};
