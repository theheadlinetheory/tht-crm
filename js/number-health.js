...
import { supabase } from './api.js?v=20260717c';
import { sbCall } from './api.js?v=20260717c';
import { esc, svgIcon } from './utils.js?v=20260717c';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260717c');
  render();
};
