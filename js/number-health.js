...
import { supabase } from './api.js?v=20260826140103';
import { sbCall } from './api.js?v=20260826140103';
import { esc, svgIcon } from './utils.js?v=20260826140103';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260826140103');
  render();
};
