...
import { supabase } from './api.js?v=20260910111105';
import { sbCall } from './api.js?v=20260910111105';
import { esc, svgIcon } from './utils.js?v=20260910111105';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260910111105');
  render();
};
