...
import { supabase } from './api.js?v=20260815162809';
import { sbCall } from './api.js?v=20260815162809';
import { esc, svgIcon } from './utils.js?v=20260815162809';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260815162809');
  render();
};
