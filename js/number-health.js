...
import { supabase } from './api.js?v=20260815171948';
import { sbCall } from './api.js?v=20260815171948';
import { esc, svgIcon } from './utils.js?v=20260815171948';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260815171948');
  render();
};
