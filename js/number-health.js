...
import { supabase } from './api.js?v=20260827214225';
import { sbCall } from './api.js?v=20260827214225';
import { esc, svgIcon } from './utils.js?v=20260827214225';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260827214225');
  render();
};
