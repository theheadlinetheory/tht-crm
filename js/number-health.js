...
import { supabase } from './api.js?v=20260717h';
import { sbCall } from './api.js?v=20260717h';
import { esc, svgIcon } from './utils.js?v=20260717h';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260717h');
  render();
};
