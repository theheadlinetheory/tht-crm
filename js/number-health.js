...
import { supabase } from './api.js?v=20260806214630';
import { sbCall } from './api.js?v=20260806214630';
import { esc, svgIcon } from './utils.js?v=20260806214630';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260806214630');
  render();
};
