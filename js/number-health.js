...
import { supabase } from './api.js?v=20260715d';
import { sbCall } from './api.js?v=20260715d';
import { esc, svgIcon } from './utils.js?v=20260715d';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260715d');
  render();
};
