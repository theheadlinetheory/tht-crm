...
import { supabase } from './api.js?v=20260801024812';
import { sbCall } from './api.js?v=20260801024812';
import { esc, svgIcon } from './utils.js?v=20260801024812';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260801024812');
  render();
};
