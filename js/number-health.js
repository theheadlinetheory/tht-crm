...
import { supabase } from './api.js?v=20260906235521';
import { sbCall } from './api.js?v=20260906235521';
import { esc, svgIcon } from './utils.js?v=20260906235521';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260906235521');
  render();
};
