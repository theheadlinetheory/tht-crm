...
import { supabase } from './api.js?v=20260814074811';
import { sbCall } from './api.js?v=20260814074811';
import { esc, svgIcon } from './utils.js?v=20260814074811';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260814074811');
  render();
};
