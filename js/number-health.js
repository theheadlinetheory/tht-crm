...
import { supabase } from './api.js?v=20260815164225';
import { sbCall } from './api.js?v=20260815164225';
import { esc, svgIcon } from './utils.js?v=20260815164225';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260815164225');
  render();
};
