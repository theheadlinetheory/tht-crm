...
import { supabase } from './api.js?v=20260801034620';
import { sbCall } from './api.js?v=20260801034620';
import { esc, svgIcon } from './utils.js?v=20260801034620';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260801034620');
  render();
};
