...
import { supabase } from './api.js?v=20260817172313';
import { sbCall } from './api.js?v=20260817172313';
import { esc, svgIcon } from './utils.js?v=20260817172313';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260817172313');
  render();
};
