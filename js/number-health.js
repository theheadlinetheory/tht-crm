...
import { supabase } from './api.js?v=20260911111229';
import { sbCall } from './api.js?v=20260911111229';
import { esc, svgIcon } from './utils.js?v=20260911111229';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260911111229');
  render();
};
