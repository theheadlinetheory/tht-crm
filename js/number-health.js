...
import { supabase } from './api.js?v=20260918092747';
import { sbCall } from './api.js?v=20260918092747';
import { esc, svgIcon } from './utils.js?v=20260918092747';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260918092747');
  render();
};
