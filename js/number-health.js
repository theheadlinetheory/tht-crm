...
import { supabase } from './api.js?v=20260916145027';
import { sbCall } from './api.js?v=20260916145027';
import { esc, svgIcon } from './utils.js?v=20260916145027';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260916145027');
  render();
};
