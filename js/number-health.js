...
import { supabase } from './api.js?v=20260720203041';
import { sbCall } from './api.js?v=20260720203041';
import { esc, svgIcon } from './utils.js?v=20260720203041';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260720203041');
  render();
};
