...
import { supabase } from './api.js?v=20260803173121';
import { sbCall } from './api.js?v=20260803173121';
import { esc, svgIcon } from './utils.js?v=20260803173121';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260803173121');
  render();
};
