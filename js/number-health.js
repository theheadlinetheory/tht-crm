...
import { supabase } from './api.js?v=20260905073617';
import { sbCall } from './api.js?v=20260905073617';
import { esc, svgIcon } from './utils.js?v=20260905073617';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260905073617');
  render();
};
