...
import { supabase } from './api.js?v=20260916145256';
import { sbCall } from './api.js?v=20260916145256';
import { esc, svgIcon } from './utils.js?v=20260916145256';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260916145256');
  render();
};
