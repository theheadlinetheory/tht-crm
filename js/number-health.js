...
import { supabase } from './api.js?v=20260731043710';
import { sbCall } from './api.js?v=20260731043710';
import { esc, svgIcon } from './utils.js?v=20260731043710';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260731043710');
  render();
};
