...
import { supabase } from './api.js?v=20260907005203';
import { sbCall } from './api.js?v=20260907005203';
import { esc, svgIcon } from './utils.js?v=20260907005203';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260907005203');
  render();
};
