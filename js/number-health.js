...
import { supabase } from './api.js?v=20260918090432';
import { sbCall } from './api.js?v=20260918090432';
import { esc, svgIcon } from './utils.js?v=20260918090432';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260918090432');
  render();
};
