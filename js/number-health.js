...
import { supabase } from './api.js?v=20260814054400';
import { sbCall } from './api.js?v=20260814054400';
import { esc, svgIcon } from './utils.js?v=20260814054400';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260814054400');
  render();
};
