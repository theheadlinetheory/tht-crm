...
import { supabase } from './api.js?v=20260816201328';
import { sbCall } from './api.js?v=20260816201328';
import { esc, svgIcon } from './utils.js?v=20260816201328';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260816201328');
  render();
};
