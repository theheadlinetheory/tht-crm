...
import { supabase } from './api.js?v=20260918073113';
import { sbCall } from './api.js?v=20260918073113';
import { esc, svgIcon } from './utils.js?v=20260918073113';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260918073113');
  render();
};
