...
import { supabase } from './api.js?v=20260910163645';
import { sbCall } from './api.js?v=20260910163645';
import { esc, svgIcon } from './utils.js?v=20260910163645';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260910163645');
  render();
};
