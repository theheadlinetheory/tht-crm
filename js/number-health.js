...
import { supabase } from './api.js?v=20260825022410';
import { sbCall } from './api.js?v=20260825022410';
import { esc, svgIcon } from './utils.js?v=20260825022410';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260825022410');
  render();
};
