...
import { supabase } from './api.js?v=20260815161907';
import { sbCall } from './api.js?v=20260815161907';
import { esc, svgIcon } from './utils.js?v=20260815161907';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260815161907');
  render();
};
