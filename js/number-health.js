...
import { supabase } from './api.js?v=20260904185541';
import { sbCall } from './api.js?v=20260904185541';
import { esc, svgIcon } from './utils.js?v=20260904185541';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260904185541');
  render();
};
