...
import { supabase } from './api.js?v=20260911095917';
import { sbCall } from './api.js?v=20260911095917';
import { esc, svgIcon } from './utils.js?v=20260911095917';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260911095917');
  render();
};
