...
import { supabase } from './api.js?v=20260905113600';
import { sbCall } from './api.js?v=20260905113600';
import { esc, svgIcon } from './utils.js?v=20260905113600';
...
window.reEnableNumber = async function(number) {
  ...
  const { render } = await import('./render.js?v=20260905113600');
  render();
};
