...
const NULLABLE_COLS = new Set(['completed_at','scheduled_time','created_at','updated_at','forwarded_at','pushed_to_tracker','pushed_to_ghl','queued_at','rerun_after','sent_at','archived_at','value','lead_cost','rerun_days','booked_date','booked_time','follow_up_date','onboarding_parsed_at','date_paid','sheet_row','stripe_customer_id','stripe_invoice_id','stripe_invoice_item_id']);
