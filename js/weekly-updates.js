...
import { showToast, sbSaveSettings, sbUpdateClient } from './api.js?v=20260910123452';
import { esc, str, svgIcon } from './utils.js?v=20260910123452';
import { crmWeekContext, ctxCheckinLines, ctxDay, ctxSummary, ctxSection } from './weekly-context.js?v=20260910123452';
import { DEFAULT_WEEKLY_UPDATE_TEMPLATE, WEEKLY_TOKENS, PPM_NOTE, applyWeeklyTemplate, weeklyGreeting } from './weekly-template.js?v=20260910123452';
