...
import { SUPABASE_URL, SUPABASE_ANON_KEY } from './config.js?v=20260923101551';
import { esc, escAttr } from './utils.js?v=20260923101551';
import { state } from './app.js?v=20260923101551';
import { openDeal } from './deal-modal.js?v=20260923101551';
import { openArchivedDeal } from './archive.js?v=20260923101551';
import { markDisco, markDemo, DISCO_OUTCOMES, DEMO_OUTCOMES, DEMO_RESCHEDULING } from './disco-outcome.js?v=20260923101551';
import { writeRemovalNote, showAcquisitionRemovalPicker } from './removal-reason.js?v=20260923101551';
import { deleteDeal } from './deals.js?v=20260923101551';
import { showClientEndPicker } from './client-end.js?v=20260923101551';
