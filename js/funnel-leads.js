...
import { esc } from './utils.js?v=20260913215731';
import { state } from './app.js?v=20260913215731';
import { openDeal } from './deal-modal.js?v=20260913215731';
import { openArchivedDeal } from './archive.js?v=20260913215731';
import { markDisco, markDemo, DISCO_OUTCOMES, DEMO_OUTCOMES } from './disco-outcome.js?v=20260913215731';
import { writeRemovalNote, showAcquisitionRemovalPicker } from './removal-reason.js?v=20260913215731';
import { deleteDeal } from './deals.js?v=20260913215731';
import { showClientEndPicker } from './client-end.js?v=20260913215731';
