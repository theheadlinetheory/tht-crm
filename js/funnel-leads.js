...
import { esc } from './utils.js?v=20260914121323';
import { state } from './app.js?v=20260914121323';
import { openDeal } from './deal-modal.js?v=20260914121323';
import { openArchivedDeal } from './archive.js?v=20260914121323';
import { markDisco, markDemo, DISCO_OUTCOMES, DEMO_OUTCOMES } from './disco-outcome.js?v=20260914121323';
import { writeRemovalNote, showAcquisitionRemovalPicker } from './removal-reason.js?v=20260914121323';
import { deleteDeal } from './deals.js?v=20260914121323';
import { showClientEndPicker } from './client-end.js?v=20260914121323';
