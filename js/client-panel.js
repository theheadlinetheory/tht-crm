...
import { esc, str, getToday, isValidDate, svgIcon } from './utils.js?v=20260910103638';
import { isAdmin } from './auth.js?v=20260910103638';
import { lookupClientInfo } from './client-info.js?v=20260910103638';
import { sbUpdateClient, sbGetWonAcquisitionCards } from './api.js?v=20260910103638';
import { registerActions } from './delegate.js?v=20260910103638';
import { buildAcquisitionCard, indexWonCards, matchCardForClient, answeredQuestions } from './client-acquisition.js?v=20260910103638';
