...
import { esc, str, getToday, isValidDate, svgIcon } from './utils.js?v=20260923114158';
import { isAdmin } from './auth.js?v=20260923114158';
import { lookupClientInfo } from './client-info.js?v=20260923114158';
import { sbUpdateClient, sbGetWonAcquisitionCards } from './api.js?v=20260923114158';
import { registerActions } from './delegate.js?v=20260923114158';
import { buildAcquisitionCard, indexWonCards, matchCardForClient, answeredQuestions } from './client-acquisition.js?v=20260923114158';
