...
import { esc, str, getToday, isValidDate, svgIcon } from './utils.js?v=20260918090653';
import { isAdmin } from './auth.js?v=20260918090653';
import { lookupClientInfo } from './client-info.js?v=20260918090653';
import { sbUpdateClient, sbGetWonAcquisitionCards } from './api.js?v=20260918090653';
import { registerActions } from './delegate.js?v=20260918090653';
import { buildAcquisitionCard, indexWonCards, matchCardForClient, answeredQuestions } from './client-acquisition.js?v=20260918090653';
