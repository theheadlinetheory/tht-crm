...
import { esc, str, getToday, isValidDate, svgIcon } from './utils.js?v=20260910153952';
import { isAdmin } from './auth.js?v=20260910153952';
import { lookupClientInfo } from './client-info.js?v=20260910153952';
import { sbUpdateClient, sbGetWonAcquisitionCards } from './api.js?v=20260910153952';
import { registerActions } from './delegate.js?v=20260910153952';
import { buildAcquisitionCard, indexWonCards, matchCardForClient, answeredQuestions } from './client-acquisition.js?v=20260910153952';
