...
import { showToast } from './api.js?v=20260908145001';
import { currentUser } from './auth.js?v=20260908145001';
import { str } from './utils.js?v=20260908145001';
import { invokeEdgeFunctionAsUser } from './edge-auth.js?v=20260908145001';
...
// key alone can no longer aim a task at someone else's account.
const createTask = (body) => invokeEdgeFunctionAsUser('create-google-task', body);
