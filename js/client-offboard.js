...
import { esc, str, getToday } from './utils.js?v=20260908140903';
import { supabase, showToast, sbArchiveDeal, sbDeleteDeal, sbUpdateClient, invokeEdgeFunction, apiPost } from './api.js?v=20260908140903';
import { SUPABASE_ANON_KEY } from './config.js?v=20260908140903';
