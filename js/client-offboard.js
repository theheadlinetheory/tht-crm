...
import { esc, str, getToday } from './utils.js?v=20260923101551';
import { supabase, showToast, sbArchiveDeal, sbDeleteDeal, sbUpdateClient, invokeEdgeFunction } from './api.js?v=20260923101551';
import { SUPABASE_ANON_KEY } from './config.js?v=20260923101551';
