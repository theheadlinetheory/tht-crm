...
import { esc, str, getToday } from './utils.js?v=20260911110145';
import { supabase, showToast, sbArchiveDeal, sbDeleteDeal, sbUpdateClient, invokeEdgeFunction } from './api.js?v=20260911110145';
import { SUPABASE_ANON_KEY } from './config.js?v=20260911110145';
