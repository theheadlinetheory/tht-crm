...
import { esc, str } from './utils.js?v=20260908143625';
import { supabase } from './api.js?v=20260908143625';
...
export function showClientEndPicker(clientId, { onDone, onCancel } = {}) {
  ...
  const finish = async (reason, kind) => {
    ...
    div.remove();
    const { openOffboard } = await import('./client-offboard.js?v=20260908143625');
