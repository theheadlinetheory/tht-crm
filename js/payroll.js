...
import { invokeEdgeFunction, showToast, supabase } from './api.js?v=20260717a';
import { esc, str } from './utils.js?v=20260717a';
...
export function renderPayroll() {
  ...
  if (!_employeesLoaded || !_paymentsLoaded || !state.trackerLoaded) {
    Promise.all([
      ...
      state.trackerLoaded ? Promise.resolve() : import('./lead-tracker.js?v=20260717a').then(m => m.loadTrackerEntries()),
