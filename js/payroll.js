...
import { invokeEdgeFunction, showToast, supabase } from './api.js?v=20260701a';
import { esc, str } from './utils.js?v=20260701a';
...
export function renderPayroll() {
  ...
  if (!_employeesLoaded || !_paymentsLoaded || !state.trackerLoaded) {
    Promise.all([
      ...
      state.trackerLoaded ? Promise.resolve() : import('./lead-tracker.js?v=20260701a').then(m => m.loadTrackerEntries()),
