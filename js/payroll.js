...
import { invokeEdgeFunction, showToast, supabase } from './api.js?v=20260703b';
...
export function renderPayroll() {
  ...
  if (!_employeesLoaded || !_paymentsLoaded || !state.trackerLoaded) {
    Promise.all([
      ...
      state.trackerLoaded ? Promise.resolve() : import('./lead-tracker.js?v=20260703b').then(m => m.loadTrackerEntries()),
