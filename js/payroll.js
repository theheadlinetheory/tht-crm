...
// ═══════════════════════════════════════════════════════════
import { state } from './app.js?v=20260724075901';
import { invokeEdgeFunction, showToast, supabase } from './api.js?v=20260724075901';
import { esc, str } from './utils.js?v=20260724075901';
...
export function renderPayroll() {
  ...
  if (!_employeesLoaded || !_paymentsLoaded || !state.trackerLoaded) {
    Promise.all([
      ...
      state.trackerLoaded ? Promise.resolve() : import('./lead-tracker.js?v=20260724075901').then(m => m.loadTrackerEntries()),
