...
import { invokeEdgeFunction, showToast, supabase } from './api.js?v=20260717f';
import { esc, str } from './utils.js?v=20260717f';
...
export function renderPayroll() {
  ...
  if (!_employeesLoaded || !_paymentsLoaded || !state.trackerLoaded) {
    Promise.all([
      ...
      state.trackerLoaded ? Promise.resolve() : import('./lead-tracker.js?v=20260717f').then(m => m.loadTrackerEntries()),
