...
// ═══════════════════════════════════════════════════════════
import { state } from './app.js?v=20260717h';
import { invokeEdgeFunction, showToast, supabase } from './api.js?v=20260717h';
import { esc, str } from './utils.js?v=20260717h';
...
export function renderPayroll() {
  ...
  if (!_employeesLoaded || !_paymentsLoaded || !state.trackerLoaded) {
    Promise.all([
      ...
      state.trackerLoaded ? Promise.resolve() : import('./lead-tracker.js?v=20260717h').then(m => m.loadTrackerEntries()),
