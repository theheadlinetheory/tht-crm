...
// ═══════════════════════════════════════════════════════════
import { state } from './app.js?v=20260717i';
import { invokeEdgeFunction, showToast, supabase } from './api.js?v=20260717i';
import { esc, str } from './utils.js?v=20260717i';
...
export function renderPayroll() {
  ...
  if (!_employeesLoaded || !_paymentsLoaded || !state.trackerLoaded) {
    Promise.all([
      ...
      state.trackerLoaded ? Promise.resolve() : import('./lead-tracker.js?v=20260717i').then(m => m.loadTrackerEntries()),
