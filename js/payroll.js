...
import { invokeEdgeFunction, showToast, supabase } from './api.js?v=20260620k';
import { esc, str } from './utils.js?v=20260620k';
...
export function renderPayroll() {
  ...
  if (!_employeesLoaded || !_paymentsLoaded || !state.trackerLoaded) {
    Promise.all([
      ...
      state.trackerLoaded ? Promise.resolve() : import('./lead-tracker.js?v=20260620k').then(m => m.loadTrackerEntries()),
