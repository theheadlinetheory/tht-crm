...
import { WEEKS, LATEST } from './triage-index.js?v=20260919001230';
import { runTriage, listSavedWeeks, getSavedWeek } from './triage-run.js?v=20260919001230';
...
function loadWeek(week) {
  ...
  PENDING[week] = true;
  import(`./triage/${week}.js?v=20260919001230`)
