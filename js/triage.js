...
import { WEEKS, LATEST } from './triage-index.js?v=20260918110319';
import { runTriage, listSavedWeeks, getSavedWeek } from './triage-run.js?v=20260918110319';
...
function loadWeek(week) {
  ...
  PENDING[week] = true;
  import(`./triage/${week}.js?v=20260918110319`)
