...
import { WEEKS, LATEST } from './triage-index.js?v=20260923154040';
import { runTriage, listSavedWeeks, getSavedWeek } from './triage-run.js?v=20260923154040';
...
function loadWeek(week) {
  ...
  PENDING[week] = true;
  import(`./triage/${week}.js?v=20260923154040`)
