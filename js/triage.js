...
import { WEEKS, LATEST } from './triage-index.js?v=20260918152403';
import { runTriage, listSavedWeeks, getSavedWeek } from './triage-run.js?v=20260918152403';
...
function loadWeek(week) {
  ...
  PENDING[week] = true;
  import(`./triage/${week}.js?v=20260918152403`)
