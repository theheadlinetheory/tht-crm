...
import { WEEKS, LATEST } from './triage-index.js?v=20260916103231';
import { runTriage, listSavedWeeks, getSavedWeek } from './triage-run.js?v=20260916103231';
...
function loadWeek(week) {
  ...
  PENDING[week] = true;
  import(`./triage/${week}.js?v=20260916103231`)
