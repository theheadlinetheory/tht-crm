...
import { invokeEdgeFunction, sbUpdateDeal, camelToSnake } from './api.js?v=20260702b';
import { esc, str, svgIcon, stripHtml, applyTemplate } from './utils.js?v=20260702b';
import { DEFAULT_DELIVERY_TEMPLATE } from './settings.js?v=20260702b';
import { findClientForDeal, lookupClientInfo, getClientThreadId } from './client-info.js?v=20260702b';
import { CRM_BASE_URL, GEOCODIO_KEY } from './config.js?v=20260702b';
...
export async function autoPushToTracker(deal){
  ...
  const { sbCreateTrackerEntry, normalizeRow } = await import('./api.js?v=20260702b');
