...
import { invokeEdgeFunction, sbUpdateDeal, camelToSnake } from './api.js?v=20260908143625';
import { esc, str, svgIcon, stripHtml, applyTemplate } from './utils.js?v=20260908143625';
import { DEFAULT_DELIVERY_TEMPLATE } from './settings.js?v=20260908143625';
import { findClientForDeal, lookupClientInfo, getClientThreadId } from './client-info.js?v=20260908143625';
import { CRM_BASE_URL, GEOCODIO_KEY } from './config.js?v=20260908143625';
...
export async function autoPushToTracker(deal){
  ...
  const { sbCreateTrackerEntry, normalizeRow } = await import('./api.js?v=20260908143625');
