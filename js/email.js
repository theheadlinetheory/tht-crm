...
import { invokeEdgeFunction, sbUpdateDeal, camelToSnake } from './api.js?v=20260905073617';
import { esc, str, svgIcon, stripHtml, applyTemplate } from './utils.js?v=20260905073617';
import { DEFAULT_DELIVERY_TEMPLATE } from './settings.js?v=20260905073617';
import { findClientForDeal, lookupClientInfo, getClientThreadId } from './client-info.js?v=20260905073617';
import { CRM_BASE_URL, GEOCODIO_KEY } from './config.js?v=20260905073617';
...
function showForwardPreview(deal, client){
  ...
  // Lead delivery always starts a fresh thread — one email per lead.
  const recipientThread='New thread (one per lead)';
...
export async function autoPushToTracker(deal){
  ...
  const { sbCreateTrackerEntry, normalizeRow } = await import('./api.js?v=20260905073617');
