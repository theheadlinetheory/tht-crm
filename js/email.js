...
import { invokeEdgeFunction, sbUpdateDeal, camelToSnake } from './api.js?v=20260526f';
import { esc, str, svgIcon, stripHtml, applyTemplate } from './utils.js?v=20260526f';
import { DEFAULT_DELIVERY_TEMPLATE } from './settings.js?v=20260526f';
import { findClientForDeal, lookupClientInfo, getClientThreadId } from './client-info.js?v=20260526f';
import { CRM_BASE_URL } from './config.js?v=20260526f';
...
export async function autoPushToTracker(deal){
  ...
  const { sbCreateTrackerEntry, normalizeRow } = await import('./api.js?v=20260526f');
