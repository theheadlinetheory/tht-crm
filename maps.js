...
import { GEOCODIO_KEY, CA_PROVINCES, CA_POSTAL, CA_CITIES, detectCountry } from './config.js?v=20260531b';
import { render, refreshModal } from './render.js?v=20260531b';
// api.js imports removed — no direct API calls in this module
import { str, esc } from './utils.js?v=20260531b';
import { findClientForDeal, lookupClientInfo } from './client-info.js?v=20260531b';
