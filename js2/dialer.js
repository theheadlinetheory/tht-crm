...
import { str, esc, uid, getToday } from './utils.js?v=20260618b';
import { invokeEdgeFunction, sbCreateActivity, camelToSnake } from './api.js?v=20260618b';
import { getBestNumberForLead, getRegionForPhone, recordCallOutcome } from './number-health.js?v=20260618b';
import { JUSTCALL_USER_MAP } from './config.js?v=20260618b';
...
async function onCallEnded(){
  ...
  try {
    ...
    const { refreshModal } = await import('./render.js?v=20260618b');
